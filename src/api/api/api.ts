...
export const APIS = [AuthServiceService, ConfigServiceService, CronWorkflowServiceService, LabelServiceService, NamespaceServiceService, SecretServiceService, ServiceServiceService, WorkflowServiceService, WorkflowTemplateServiceService, WorkspaceServiceService, WorkspaceTemplateServiceService];
