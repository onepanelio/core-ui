...
export * from './inferenceService.service';
import { InferenceServiceService } from './inferenceService.service';
...
export const APIS = [AuthServiceService, ConfigServiceService, CronWorkflowServiceService, FileServiceService, InferenceServiceService, LabelServiceService, NamespaceServiceService, SecretServiceService, ServiceServiceService, WorkflowServiceService, WorkflowTemplateServiceService, WorkspaceServiceService, WorkspaceTemplateServiceService];
