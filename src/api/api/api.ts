...
export const APIS = [AuthServiceService, CronWorkflowServiceService, LabelServiceService, NamespaceServiceService, SecretServiceService, WorkflowServiceService, WorkflowTemplateServiceService, WorkspaceTemplateServiceService];
