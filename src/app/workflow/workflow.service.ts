...
// https://github.com/argoproj/argo/blob/master/pkg/apis/workflow/v1alpha1/workflow_types.go#L39
// we add terminated for internal use
export type WorkflowPhase = 'Pending' | 'Running' | 'Succeeded' | 'Skipped' | 'Failed' | 'Error' | 'Omitted' | 'Terminated';
...
export class SimpleWorkflowDetail {
    ...
    updateWorkflowManifest(manifest: string) {
        ...
        const jsonTemplateManifest = yaml.safeLoad(this.workflowTemplate.manifest);
